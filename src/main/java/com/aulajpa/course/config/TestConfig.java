...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-02-01T13:57:30Z"), u1);
		Order o2 = new Order(null, Instant.parse("2025-02-01T13:59:45Z"), u2);
		Order o3 = new Order(null, Instant.parse("2025-02-01T14:05:10Z"), u1);
